...
export function MobileTabBar({
  ...
  return (
    <div className={`flex items-center justify-center gap-2 w-full select-none ${className}`}>
      ...
      <nav
        className={`bg-[#14171c]/95 backdrop-blur-2xl border border-white/10 p-1.5 rounded-full shadow-2xl relative flex items-center h-[70px] transition-all duration-300 ${
          seasonEnded ? 'w-[230px]' : 'flex-1 min-w-0'
        }`}
      >
      ...
      <div className="h-[70px] w-[70px] shrink-0 bg-[#14171c]/95 backdrop-blur-2xl border border-white/10 p-1.5 rounded-full shadow-2xl flex items-center justify-center relative">
        <button
