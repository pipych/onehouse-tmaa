          ...
          <div className="p-5 md:p-6 pt-2 flex flex-col gap-5 flex-grow">
            ...
            <div className="flex items-center justify-start gap-3 mt-2 select-none">
              ...
              <button 
                ...
                className="flex items-center justify-center gap-2 px-4 py-2 bg-white/5 border border-white/5 rounded-full text-gray-400 hover:text-[#c0ff00] transition-all text-xs font-bold font-mono min-w-[90px]"
              >
                <Share2 size={15} />
